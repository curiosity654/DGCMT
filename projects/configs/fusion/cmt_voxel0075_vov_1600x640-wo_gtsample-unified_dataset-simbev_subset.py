...
out_size_factor = 8
evaluation = dict(interval=4, use_numba_eval=True)
dataset_type = 'UnifiedMMDet3DDataset'
data_root = 'data/simbev/original'
input_modality = dict(
    use_lidar=True,
    use_camera=True,
    use_radar=False,
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
             init_kwargs=dict(
                 ...
                 name='cmt_voxel0075_vov_1600x640-simbev',
             ))
    ])
...
# resume_from = "work_dirs/cmt_voxel0075_vov_1600x640-wo_gtsample-unified_dataset-simbev_subset/latest.pth"
resume_from = None
