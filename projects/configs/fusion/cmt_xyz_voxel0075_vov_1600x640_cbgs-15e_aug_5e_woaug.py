...
train_pipeline = [
    ...
    dict(type='DropPointsDim', keep_dims=[0, 1, 2]),
...
log_config = dict(
    ...
    hooks=[dict(type='TextLoggerHook'),
           ...
           dict(type='WandbLoggerHook',init_kwargs=dict(project='Dataset Generalize Fusion', name='cmt_xyz_voxel0075_vov_1600x640_cbgs-15e_aug_5e_woaug',))])
