"""
Argoverse2 Zero-shot Test Configuration - 1600x1600 Resolution

This config uses ResizeCropFlipImage to resize Argoverse2 images to 1600x1600.
Original AV2 image size: 2048x1550 (W x H)
Target: 1600x1600 (aspect-ratio preserving resize + crop/pad)

Key settings:
- resize_lim: (0.78, 0.78) for consistent 1600 width
- final_dim: (1600, 1600) 
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            # Step 1: Resize longest side to 1600, keep aspect ratio
            dict(type='ResizeMultiViewImage', size=(1600, 1600), keep_ratio=True),
