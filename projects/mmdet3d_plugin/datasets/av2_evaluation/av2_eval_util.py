...
def groupby(keys: List[str], values: NDArrayFloat) -> Dict[str, NDArrayFloat]:
    """Group values by keys.
    
    Args:
        keys: List of string keys.
        values: Numpy array of values, one per key.
        
    Returns:
        Dictionary mapping each unique key to a numpy array of corresponding values.
    """
    groups: Dict[str, List[NDArrayFloat]] = {}
...
def evaluate(
    ...
    # `groupby` produces a mapping from the uuid to the group of detections / annotations
