...
@HOOKS.register_module()
class CustomFp16GradientCumulativeOptimizerHook(GradientCumulativeFp16OptimizerHook):

    def __init__(self,
                custom_fp16={},
                *args,
                **kwargs):
        super(CustomFp16GradientCumulativeOptimizerHook, self).__init__(*args, **kwargs)
        self.custom_fp16 = custom_fp16
